...
@itemlist[
  ...
  @item{@tt{hostname} (@hyperlink[#:underline #f]{RFC 1034})}
  @item{@tt{ipv4} (@hyperlink[#:underline #f]{RFC 2673})}
  @item{@tt{ipv6} (@hyperlink[#:underline #f]{RFC 2373})}
  @item{@tt{uri} (@hyperlink[#:underline #f]{RFC 3986})}
  @item{@tt{uri-reference} (ditto)}
  @item{@tt{uri-template} (@hyperlink[#:underline #f]{RFC 6570}), and}
  @item{@tt{json-pointer} (@hyperlink[#:underline #f]{RFC 6901})}
]
