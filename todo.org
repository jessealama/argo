...
* TODO Verify that the Space Telescope Institute address schema really is a schema
  :LOGBOOK:
  CLOCK: [2017-08-05 Sat 06:05]--[2017-08-05 Sat 07:26] =>  1:21
  :END:
  definitions keyword not handled?
* TODO Verify the positive integer example
* TODO Add regular expression tests
  https://spacetelescope.github.io/understanding-json-schema/reference/regular_expressions.html
* TODO JSON pointers
** TODO Define a test for whether a string is a JSON pointer
...
*** TODO Add tests from the Space Telescope Science Institute example
